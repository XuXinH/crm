...
<script type="text/javascript">
    ...
    function del(cid){
        ...
        if(ok){
            document.location.href="${pageContext.request.contextPath}/CourseDelServlet?cid="+cid;
    ...
    function delAll(){
        ...
        if(ok){
            document.location.href="${pageContext.request.contextPath}/CourseDeleteAllServlet";
        }

    }

    function checks(){
        var all = document.getElementById("check1_1");
        var one = document.getElementsByName("cid[]");
