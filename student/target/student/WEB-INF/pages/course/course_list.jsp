...
<div class="container mt-3">
    ...
    <table class="table table-hover">
        ...
        <tbody>
        <c:forEach items="${course}" var="cour" varStatus="idx">
            <tr>
                <td>
                ...
                <td>${cour.cname}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/course/del?cid=${cour.cid}">
                        <button type="button" class="btn btn-danger">删除</button>
                    </a>
                    <a href="${pageContext.request.contextPath}/course/getCourse?cid=${cour.cid}">
